...
class ScanDirectoryView(View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        messages.success(request, f"Scanned {scanned_files} files, added {new_tracks} new tracks")
        return redirect('index')
...
class PlayTrackView(View):
    def get(self, request, track_id, *args, **kwargs):
        ...
        response['Content-Disposition'] = f'inline; filename="{os.path.basename(track.file_path)}"'
        return response
